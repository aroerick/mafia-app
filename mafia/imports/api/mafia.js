...
const roleArr = ['mafia', 'doctor', 'detective', 'ciivlian', 'civilian', 'mafia']
    ...
    "game.nextPhase" (){
        ...
        Meteor.setTimeout(function(){
            ...
            Messages.insert({
                sender: 'Narrator',
                recipient: 'Everyone',
                text: 'The moon has risen.  As the civilians of this township lay their heads to sleep, the doctor, the detective, and the mafia are awakening to finish their tasks'
            }),
            Messages.insert({
                sender: 'Narrator',
                recipient: 'Mafia',
            ...
            Messages.insert({
                sender: 'Narrator',
                recipient: 'Doctor',
                text: 'It appears a bug is spreading through the town.  Who shall we check on tonight?',
            }),
            Messages.insert({
                sender: 'Narrator',
                recipient: 'Detective',
